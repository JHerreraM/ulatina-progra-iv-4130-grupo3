			...
			<div class="pad_1">
				...
				<form name="reservacion" id="form_1" action="../reservacion/vueloSalida" method="post">
					...
					<div class="wrapper" style="margin-top: 10px;">
						...
						<p>Pasajero(s):</p> -->
						<div class="bg left">
                                                <!-- <input type="text" name="numPasajeros" class="input input2" value="# Pasajeros" onblur="if(this.value=='') this.value='# Pasajeros'" onFocus="if(this.value =='# Pasajeros' ) this.value=''"> -->
                                                </div>
                                                <a style="padding-top: 10px;" href="javascript:submitReservacion();" class="button2" onClick="document.getElementById('form_1').submit()">go!</a>
					</div>
