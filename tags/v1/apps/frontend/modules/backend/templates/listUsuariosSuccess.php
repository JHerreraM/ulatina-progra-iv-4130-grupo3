...
?>  
                ...
                <div class="module">
                	...
                	<h2><span>Listado de Usuarios</span></h2>
                    ...
                    <div class="module-table-body">
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                <tr>
                                    <th style="width:5%">#</th>
                                    <th style="width:20%">Cod. Usuario</th>
                            ...
                            <tbody>
                                <?php 
                                   $cont = 0;
                                ?> 
                                <?php foreach($usuarios as $usuario){ $cont = $cont + 1;?>      
                                <tr>
                                    ...
                                    <td>
                                    	<input type="checkbox" name="perBorrar[]" value ="<?php echo $usuario["codigo_usuario"] ?>"/>
                                        <a href="listUsuarios?editUsuario=<?php echo $usuario["codigo_usuario"] ?>&accionSelec=4"><img src="../images/minus-circle.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/minus-circle.gif" width="16" height="16" alt="not published"></a>
                                        <a href="editUsuarios?usuarioEdit=<?php echo $usuario["codigo_usuario"] ?>"><img src="../images/pencil.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/pencil.gif" width="16" height="16" alt="edit" /></a>
                                    </td>
                                </tr>
                              <?php } ?>      
                        ...
                        <a href="editUsuarios"><input class="submit-green" type="button" value="Agregar"></a></br></br>
                        </form>
